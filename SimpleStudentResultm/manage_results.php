...
<body>
    ...
    <div class="nav">
      <ul>
        <li><a href="dashboard.php"><img src="images\admin1.png" alt="">&nbspDashboard</a></li>
        ...
        <li><a class="active" href="manage_results.php"><img src="images\project-management 1.png" alt="">&nbspManage Result</a></li>
      </ul>
    </div>
    <div class="main">
        <br><br>
        <form action="" method="post">
            <fieldset>
                <legend><img src="images\delete.png" alt="delete-logo">Delete Result</legend>
                <?php
                    include('init.php');
                    include('session.php');
        ...
        <form action="" method="post">
            <fieldset>
                <legend><img src="images\updated.png" alt="update-logo">Update Result</legend>
